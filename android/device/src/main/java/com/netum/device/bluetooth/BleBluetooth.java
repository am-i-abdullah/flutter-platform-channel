...
import com.netum.device.exception.ConnectException;
import com.netum.device.exception.OtherException;
import com.netum.device.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        if (bluetoothGatt != null) {
            ...
            BLEManager.getInstance().getMultipleBluetoothBLEController().removeConnectingBle(BleBluetooth.this);
            if (bleGattCallback != null)
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BleMsg.MSG_DISCONNECTED: {
                    ...
                    BLEManager.getInstance().getMultipleBluetoothBLEController().removeBleBluetooth(BleBluetooth.this);
                ...
                case BleMsg.MSG_DISCOVER_SUCCESS: {
                    ...
                    BLEManager.getInstance().getMultipleBluetoothBLEController().removeConnectingBle(BleBluetooth.this);
                    BLEManager.getInstance().getMultipleBluetoothBLEController().addBleBluetooth(BleBluetooth.this);
