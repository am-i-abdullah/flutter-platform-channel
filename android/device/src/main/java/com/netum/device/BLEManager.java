...
import com.netum.device.bluetooth.BleBluetooth;
import com.netum.device.bluetooth.MultipleBluetoothBLEController;
import com.netum.device.bluetooth.SplitWriter;
import com.netum.device.callback.BleGattCallback;
import com.netum.device.callback.BleIndicateCallback;
import com.netum.device.callback.BleMtuChangedCallback;
import com.netum.device.callback.BleNotifyCallback;
import com.netum.device.callback.BleReadCallback;
import com.netum.device.callback.BleRssiCallback;
...
import com.netum.device.scan.BleScanner;
...
public class BLEManager {
    ...
    private MultipleBluetoothBLEController multipleBluetoothBLEController;
    ...
    public void init(Application app) {
        if (context == null && app != null) {
            ...
            multipleBluetoothBLEController = new MultipleBluetoothBLEController();
     ...
     * @return
     */
    public MultipleBluetoothBLEController getMultipleBluetoothBLEController() {
        return multipleBluetoothBLEController;
    }
    ...
    public void scan(BleScanCallback callback) {
        ...
        BleScanner.getInstance().scan(serviceUuids, deviceNames, deviceMac, fuzzy,filter, timeOut, callback);
    }
    ...
    public void scanAndConnect(BleScanAndConnectCallback callback) {
        ...
        BleScanner.getInstance().scanAndConnect(serviceUuids, deviceNames, deviceMac, fuzzy,filter, timeOut, callback);
    }
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (bleDevice == null || bleDevice.getDevice() == null) {
            ...
            BleBluetooth bleBluetooth = multipleBluetoothBLEController.buildConnectingBle(bleDevice);
     ...
     * @param callback
     */
    public void startReceive(BleDevice bleDevice,
                             BleNotifyCallback callback){
        notify(bleDevice, ServiceList.BLEServiceUUID.toString(), ServiceList.NotifyUUID.toString(), callback);
    }
    ...
    public void notify(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothBLEController.getBleBluetooth(bleDevice);
     ...
     * @return
     */
    public boolean stopReceive(BleDevice bleDevice) {
        return stopNotify(bleDevice, ServiceList.BLEServiceUUID.toString(), ServiceList.NotifyUUID.toString());
    }
    ...
    public void ScannerCommand(BleDevice bleDevice,
        ...
        write(bleDevice,ServiceList.BLEServiceUUID.toString() , ServiceList.WriteUUID.toString(), data, false, callback);
    }
    ...
    public BleBluetooth getBleBluetooth(BleDevice bleDevice) {
        if (multipleBluetoothBLEController != null) {
            return multipleBluetoothBLEController.getBleBluetooth(bleDevice);
        }
        return null;
    }
    ...
    public List<BleDevice> getAllConnectedDevice() {
        if (multipleBluetoothBLEController == null)
            return null;
        return multipleBluetoothBLEController.getDeviceList();
    }
    ...
    public void disconnect(BleDevice bleDevice) {
        if (multipleBluetoothBLEController != null) {
            multipleBluetoothBLEController.disconnect(bleDevice);
        }
    }

    public void disconnectAllDevice() {
        if (multipleBluetoothBLEController != null) {
            multipleBluetoothBLEController.disconnectAllDevice();
        }
    }

    public void destroy() {
        if (multipleBluetoothBLEController != null) {
            multipleBluetoothBLEController.destroy();
        }
    }
